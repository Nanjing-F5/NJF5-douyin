...
func Router() {
...

	{
		...
		//web.GET("/publish/list/", controller.PublishList)
		//
		//// extra apis - I
		//web.POST("/favorite/action/", controller.FavoriteAction)
		//web.GET("/favorite/list/", controller.FavoriteList)
		//web.POST("/comment/action/", controller.CommentAction)
		//web.GET("/comment/list/", controller.CommentList)
		//
		//// extra apis - II
		//web.POST("/relation/action/", controller.RelationAction)
		//web.GET("/relation/follow/list/", controller.FollowList)
		//web.GET("/relation/follower/list/", controller.FollowerList)
